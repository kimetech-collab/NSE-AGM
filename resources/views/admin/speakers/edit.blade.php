                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="first_name" 
                                value="{{ old('first_name', $speaker->first_name) }}"
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="last_name" 
                                value="{{ old('last_name', $speaker->last_name) }}"
                                class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                                required
                            >
                            @error('last_name')
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="organization" 
                                value="{{ old('organization', $speaker->organization) }}"
                ...
                <fieldset>
                    ...
                    <div class="space-y-4">
                        @if($speaker->photo_url)
                            <div>
                                <p class="text-sm font-medium text-nse-neutral-700 mb-2">Current Photo</p>
                                <img src="{{ $speaker->photo_url }}" alt="{{ $speaker->full_name }}" class="w-24 h-24 rounded object-cover border border-nse-neutral-200">
                            </div>
                        @endif
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="photo_url" 
                                value="{{ old('photo_url', $speaker->photo_url) }}"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-nse-neutral-700 mb-1">Upload New Photo (JPG, PNG - Max 5MB)</label>
                            <input 
                                type="file" 
                                name="photo_file" 
                                ...
                                class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                            >
                            <p class="text-xs text-nse-neutral-500 mt-1">Leave blank to keep current photo</p>
                            @error('photo_file')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input 
                                type="url" 
                                name="website_url" 
                                value="{{ old('website_url', $speaker->website_url) }}"
                                placeholder="https://..."
                                class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                            >
                            @error('website_url')
                        ...
                        <div>
                            ...
                            <input 
                                type="url" 
                                name="twitter_url" 
                                value="{{ old('twitter_url', $speaker->twitter_url) }}"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('expertise_topics', $speaker->expertise_topics ? implode(', ', $speaker->expertise_topics) : '') }}"
                        ...
                        <div>
                            ...
                            <input 
                                type="text" 
                                name="session_title" 
                                value="{{ old('session_title', $speaker->session_title) }}"
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                            >{{ old('session_description', $speaker->session_description) }}</textarea>
                            <p class="text-xs text-nse-neutral-500 mt-1">Maximum 5000 characters</p>
                        ...
                        <div>
                            ...
                            <input 
                                type="datetime-local" 
                                name="session_time" 
                                value="{{ old('session_time', $speaker->session_time ? $speaker->session_time->format('Y-m-d\TH:i') : '') }}"
                                class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                            >
                            @error('session_time')
                                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-3">
                            <input 
                                ...
                                name="is_keynote" 
                                value="1"
                                {{ old('is_keynote', $speaker->is_keynote) ? 'checked' : '' }}
                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <input 
                            type="number" 
                            name="sort_order" 
                            value="{{ old('sort_order', $speaker->sort_order) }}"
                            min="0"
                            max="9999"
                            class="w-full border border-nse-neutral-300 rounded px-3 py-2 focus:ring-2 focus:ring-nse-green-500 focus:border-transparent"
                        >
