...
@section('admin_content')
    <div class="p-6 space-y-6">
        <x-admin.page-header
            title="Edit Programme Item"
            subtitle="Update schedule details and visibility settings."
        />

        <x-admin.panel class="p-6">
            <form method="POST" action="{{ route('admin.programme.update', $programmeItem) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <fieldset class="border border-nse-neutral-200 rounded-lg p-4 md:p-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title', $programmeItem->title) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>
                            @error('title')<p class="text-red-600 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-nse-neutral-700 mb-1">Category</label>
                            <input type="text" name="category" value="{{ old('category', $programmeItem->category) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <input type="date" name="programme_date" value="{{ old('programme_date', $programmeItem->programme_date->format('Y-m-d')) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>
                        ...
                        <div>
                            ...
                            <input type="time" name="start_time" value="{{ old('start_time', $programmeItem->start_time) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>
                        ...
                        <div>
                            ...
                            <input type="time" name="end_time" value="{{ old('end_time', $programmeItem->end_time) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="track" value="{{ old('track', $programmeItem->track) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="location" value="{{ old('location', $programmeItem->location) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="speaker_name" value="{{ old('speaker_name', $programmeItem->speaker_name) }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div>
                            ...
                            <input type="number" name="sort_order" value="{{ old('sort_order', $programmeItem->sort_order) }}" min="0" max="9999" class="w-full border border-nse-neutral-300 rounded px-3 py-2">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="4" class="w-full border border-nse-neutral-300 rounded px-3 py-2">{{ old('description', $programmeItem->description) }}</textarea>
                ...
                <fieldset class="border border-nse-neutral-200 rounded-lg p-4 md:p-5">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-3">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $programmeItem->is_featured) ? 'checked' : '' }} class="rounded border-nse-neutral-300">
                            <span class="text-sm text-nse-neutral-700">Mark as featured item</span>
                        </label>

                        <label class="flex items-center gap-3">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $programmeItem->is_active) ? 'checked' : '' }} class="rounded border-nse-neutral-300">
