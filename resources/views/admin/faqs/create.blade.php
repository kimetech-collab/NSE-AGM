            ...
            <form method="POST" action="{{ route('admin.faqs.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="category" value="{{ old('category') }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>
                ...
                <div>
                    ...
                    <input type="text" name="question" value="{{ old('question') }}" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>
                ...
                <div>
                    ...
                    <textarea name="answer" rows="6" class="w-full border border-nse-neutral-300 rounded px-3 py-2" required>{{ old('answer') }}</textarea>
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-nse-neutral-200">
                    <button type="submit" class="px-5 py-2 bg-nse-green-700 text-white text-sm rounded font-medium hover:bg-nse-green-800">Create FAQ</button>
