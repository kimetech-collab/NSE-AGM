                ...
                @if(auth()->user()->hasRole('super_admin'))
                    <div class="pt-4 mt-4 border-t border-gray-200">
                        ...
                        <a href="{{ route('admin.programme.index') }}" 
                           ...
                           class="admin-nav-link flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.programme*') ? 'bg-nse-green-700 text-white font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                            </svg>
                            <span class="admin-nav-label">Programme</span>
                        </a>

                        <a href="{{ route('admin.faqs.index') }}" 
                                    title="FAQs"
                                    aria-label="FAQs"
                           class="admin-nav-link flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.faqs*') ? 'bg-nse-green-700 text-white font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="admin-nav-label">FAQs</span>
                        </a>

                        <a href="{{ route('admin.venues.index') }}" 
                                    title="Venue"
                                    aria-label="Venue"
                           class="admin-nav-link flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.venues*') ? 'bg-nse-green-700 text-white font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                            </svg>
                            <span class="admin-nav-label">Venue</span>
                        </a>
                        ...
                        <a href="{{ route('admin.roles.index') }}" 
                           ...
                           class="admin-nav-link flex items-center gap-3 px-4 py-2 rounded-lg transition {{ request()->routeIs('admin.roles*') ? 'bg-nse-green-700 text-white font-semibold' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/>
                            </svg>
                            <span class="admin-nav-label">Roles & Permissions</span>
                        </a>
